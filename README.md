...
Not affiliated with ppy Pty Ltd. or _osu!_.
...
_tatakae!_ (as of now, July 7, 2026) and its modifications to software is licensed under the MIT license, as is base _osu!_(lazer).

_tatakae!_ uses osu-resources which is under a CC-BY-NC 4.0 license.

If you are to use this fork at an event, contact peppy at <pe@ppy.sh> beforehand as using the _osu!_ logo and trademark without permission is illegal.
...
You can also build and run _osu!_ from the command-line with a single command:
